...
export default (editor) => {
  ...
  bm.add("rsvp-buttons", {
    ...
    content: () => {
      const id = uuidv4();
      return `
        <div id="rsvp-container-${id}" class="rsvp-group" data-rsvp-block-id="${id}" style="display:flex; gap:10px; justify-content:center; padding:20px;">
  ...
  bm.add("guest-qrcode", {
    ...
    content: {
      ...
      attributes: {
        class: "qr_code",
        alt: "[QR Code]",
        src: "https://via.placeholder.com/150x150?text=QR+Code",
  ...
  bm.add("address", {
    ...
    content: {
      type: "text",
      content:
        "Jl. H. Haris Cluster Harris No. Kav 1-3, RT 01/RW 10, Baros, Kec. Cimahi Tengah, Kota Cimahi, Jawa Barat, 40521",
      attributes: {
        class: "address",
  ...
  bm.add("location-link", {
    ...
    content: {
      ...
      content: "Open Maps",
      attributes: {
        href: "https://maps.google.com/?q=-75.674316,-86.10745",
        target: "_blank",
        title: "Open Location in Google Maps",
        class: "location_link",
        style:
          "display:inline-block; padding:10px 20px; background:#007bff; color:white; text-decoration:none; border-radius:5px; text-align:center;",
      },
    },
  });
};
